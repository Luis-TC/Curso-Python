...
"""
"""
#def contador_total(cancion):
     letra = cancion.lower().replace(",", "")
     palabras = letra.split()
     total_palabras = len(palabras) 
     return total_palabras

def contador_palabra(cancion,palabra):
     letra = cancion.lower().replace(",", "")
     palabras = letra.split()
    contar_pollito = palabras.count("pollito")
    return cant_palabra
"""

def palabras_no_repetidas(letra):
    letra = cancion.lower().replace(",", "")
    palabras = letra.split()
...
print(f"Total de palabras no repetidas: {len(palabras_no_repetidas)}")
print("Palabras no repetidas:", palabras_no_repetidas)